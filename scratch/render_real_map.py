...
# Badge
display_title = "도마·변동 5구역 재정비촉진지구"
badge_w = 260
badge_h = 32
...
p.end()
img.save("scratch/test_geo_map_result.png")
print("Saved scratch/test_geo_map_result.png")
