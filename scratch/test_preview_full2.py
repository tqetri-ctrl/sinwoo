...
tb.setHtml(html)
tb.show()
tb.grab().save("scratch/test_preview_full2.png")
print("Saved scratch/test_preview_full2.png")
print("Horizontal scrollbar visible:", tb.horizontalScrollBar().isVisible())
